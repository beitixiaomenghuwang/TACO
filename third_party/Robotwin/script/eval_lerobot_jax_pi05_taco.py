...
使用JAX训练的PI0.5模型 + PyTorch的CFN模块进行评估
"""
...
# 导入JAX版本的PI0.5模型包装器
from policy.pi05 import pi05_model_jax
...
def main(usr_args):
    ...
    train_config_name = usr_args.get("train_config_name", "pi0_fast_aloha")
    ...
    # 创建JAX版本的PI0.5 + TACO模型
    model = pi05_model_jax.JAX_PI05_TACO(
        task_name=task_name,
